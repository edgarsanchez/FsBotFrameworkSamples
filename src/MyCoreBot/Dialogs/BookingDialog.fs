...
type BookingDialog () as __ =
    ...
    let confirmStepAsync (stepContext: WaterfallStepContext) cancellationToken =
        ...
        let messageText = $"Please confirm, I have you traveling to: {bookingDetails.Destination} from: {bookingDetails.Origin} on: {bookingDetails.TravelDate}. Is this correct?"
